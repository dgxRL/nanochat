...
# Model loading
parser.add_argument("--model-tag", type=str, default="d6", help="model tag to load from")
parser.add_argument("--model-step", type=int, default="5000", help="model step to load from")
# Training horizon
